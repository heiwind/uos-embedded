...
int vesa_get_info (vesa_info_t *i);
int vesa_get_mode_info (unsigned short mode, vesa_mode_info_t *i);
int vesa_get_display_info (vesa_display_t *specs);
unsigned short vesa_get_mode (void);
int vesa_set_mode (unsigned short mode);
int vesa_set_palette (int first, int count, void *data);
