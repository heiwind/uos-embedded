...
#define bit_RXBF_FULL		12	// Индикатор переполнения буфера ПРМ при приеме пакета
#define bit_DSCR_nREADY		11	// (зарезервировано)
#define bit_RXL			10	// Индикатор приема пакета длиной более MaxFrame
#define bit_RXS			9	// Индикатор приема пакета длинойменее MinFrame
...
#define bit_TX_DSCR_SCAN_EN	12	// Переключение ПРД в режим сканирования
					// дескрипторов, когда переход к следующему
...
#define bit_ERR_FRAME_EN	4	// Разрешение приема пакетов с ошибками (активный уровень "1")
...
#define bit_TX_DSCR_IRQ_EN	13	// Разрешение формирования прерываний по передаче (1-вкл., 0выкл.)
#define bit_TX_DSCR_PRE_DIS	10	// Отключение передачи преамбулы (1-передача преамбулы отключена, 0-стандартный пакет)
#define bit_TX_DSCR_PAD_DIS	9	// Отключение дополнения пакетов длиной менее MinFrame до минимальной длины PAD-ами (1-дополнение не производится, 0-дополнение производится)
...
#define bit_RX_DSCR_IRQ_EN	13 // Разрешение формирования прерываний по передаче (1-вкл., 0выкл.)
...
#define dflt_HASH0		0x0000
#define dflt_HASH1		0x0000
#define dflt_HASH2		0x0000
#define dflt_HASH3		0x8000	// Hash is empty
