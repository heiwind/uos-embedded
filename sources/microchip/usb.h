...
//
#include <microchip/usb_common.h>	// Common USB library definitions
#include <microchip/usb_ch9.h>		// USB device framework definitions
#include <microchip/usb_hal.h>		// Hardware Abstraction Layer interface

#if defined( USB_SUPPORT_DEVICE )
    #include <microchip/usb_device.h>	// USB Device abstraction layer interface
#endif

#if defined( USB_SUPPORT_HOST )
    #include <microchip/usb_host.h>	// USB Host abstraction layer interface
#endif

#if defined ( USB_SUPPORT_OTG )
    #include <microchip/usb_otg.h>
#endif
