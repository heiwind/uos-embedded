 ...
 *	2:0 = function
 */
#define PCI_BUSDEVFN(bus,slot,func)	((((bus) & 0xff) << 8) | \
					 (((slot) & 0x1f) << 3) | \
					 ((func) & 0x07))
#define PCI_BUS(bdevfn)			(((bdevfn) >> 8) & 0xff)
#define PCI_SLOT(bdevfn)		(((bdevfn) >> 3) & 0x1f)
#define PCI_FUNC(bdevfn)		((bdevfn) & 0x07)

typedef struct _pcibios_t {
	/* PCI BIOS service pointer. */
	unsigned long entry_address;
	unsigned short entry_segment;

	unsigned char version_major;
	unsigned char version_minor;
	unsigned char hw_mechanism;
