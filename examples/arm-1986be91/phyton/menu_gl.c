...
static void DisplayTriangle (unsigned x, unsigned y, unsigned side) {
...
static void DisplayFillingTriangle (unsigned x, unsigned y, unsigned side) {
    unsigned i;
    for (i = 0; i < side + 1; i++)
...
/* Отрисовка круга */
void DisplayFillingCircle (unsigned x, unsigned y, unsigned radius) {
    unsigned i;
...
void DisplayRectangle (unsigned x, unsigned y, unsigned side_x, unsigned side_y) {
...
void DisplayFillingRectangle (unsigned x, unsigned y, unsigned side_x, unsigned side_y) {
    unsigned i;
    for (i = 0; i < side_y; i++)
