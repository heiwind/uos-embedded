...
(test-snmp, test-telnetd) не получается собрать в варианте, когда код и данные 
в CRAM. Но при этом тесты TCP и UDP показывают практически полную загрузку шины 
Ethernet.
