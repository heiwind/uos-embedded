...
void		GsDestroyRegion(GR_REGION_ID region);
void		GsDestroyFont(GR_FONT_ID fontid);
void		GsDestroyCursor(GR_CURSOR_ID cid);
void		GsDestroyTimer (GR_TIMER_ID tid);
void		GsFreeImage(GR_IMAGE_ID id);
void		GsUngrabKey(GR_WINDOW_ID id, GR_KEY key);
...
#define curclient	(*(GR_CLIENT**) &task_current->privatep)
#else
