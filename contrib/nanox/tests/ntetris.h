...
#define MAIN_WINDOW_BACKGROUND_COLOUR MWRGB(0,0,128) /* navy blue */

#define SCORE_WINDOW_WIDTH BUTTON_WIDTH
#define SCORE_WINDOW_HEIGHT 50
...
static const GR_COLOR block_colours[MAXSHAPES] = {
	GR_COLOR_GRAY,		/* **** */
