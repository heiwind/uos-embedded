//
// "$Id: Fl_Text_Buffer.cxx,v 1.4 2008-05-05 15:25:59 vak Exp $"
//
...
int Fl_Text_Buffer::expand_character( char c, int indent, char *outStr, int tabDist,
  ...
  if ( ( ( unsigned char ) c ) <= 31 ) {
    snprintf( outStr, 6, "<%s>", ControlCodeTable[ ( unsigned char ) c ] );
    return strlen( outStr );
  } else if ( c == 127 ) {
    snprintf( outStr, 6, "<del>" );
    return 5;
  } else if ( c == nullSubsChar ) {
    snprintf( outStr, 6, "<nul>" );
    return 5;
  }
...
//
// End of "$Id: Fl_Text_Buffer.cxx,v 1.4 2008-05-05 15:25:59 vak Exp $".
//
