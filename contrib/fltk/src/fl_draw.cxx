//
// "$Id: fl_draw.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $"
//
...
void fl_draw(
  ...
  if (str) {
	...
	callthis("_",1,xpos+int(fl_width(buf,underline_at-buf)),ypos-desc+1);
...
//
// End of "$Id: fl_draw.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $".
//
