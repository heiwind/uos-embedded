//
// "$Id: forms_timer.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $"
//
...
void Fl_Timer::draw() {
  ...
  if (type() == FL_VALUE_TIMER && delay>0.0) {
    ...
    if (d < 60.0)
      snprintf(str, sizeof(str), "%.1f", d);
    else {
      tt = (int) ((d+0.05) / 60.0);
      snprintf(str, sizeof(str), "%d:%04.1f", tt, d - 60.0 * tt);
    }
...
//
// End of "$Id: forms_timer.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $".
//
