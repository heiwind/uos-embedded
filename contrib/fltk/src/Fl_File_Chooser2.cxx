//
// "$Id: Fl_File_Chooser2.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $"
//
...
Fl_File_Chooser::favoritesButtonCB()
{
  ...
  if (!v) {
    ...
    snprintf(menuname, sizeof(menuname), "favorite%02d", v);
...
//
// End of "$Id: Fl_File_Chooser2.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $".
//
