//
// "$Id: Fl_Pixmap.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $"
//
  ...
  if (ncolors < 0) {
	...
	while (*p && !isspace(*p)) p++;
      ...
      if (fl_parse_color(p, r, g, b)) {
        ...
        if (chars_per_pixel > 1) snprintf(line, sizeof(line), "%c%c c #%02X%02X%02X",
	                                 data()[color + 1][0],
	                                 data()[color + 1][1], r, g, b);
        else snprintf(line, sizeof(line), "%c c #%02X%02X%02X", data()[color + 1][0], r, g, b);
  ...
  if (ncolors < 0) {
	...
	while (*p && !isspace(*p)) p++;
      ...
      if (fl_parse_color(p, r, g, b)) {
        ...
        if (chars_per_pixel > 1) snprintf(line, sizeof(line), "%c%c c #%02X%02X%02X", data()[i + 1][0],
	                                 data()[i + 1][1], g, g, g);
        else snprintf(line, sizeof(line), "%c c #%02X%02X%02X", data()[i + 1][0], g, g, g);
...
//
// End of "$Id: Fl_Pixmap.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $".
//
