//
// "$Id: Fl_get_system_colors.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $"
//
...
//    printf("FL_GRAY = 0x%02x 0x%02x 0x%02x\n", r, g, b);
    ...
    for (i = 0; i < 3; i ++) {
      ...
      snprintf(tile_cmap[i], 12, "%c c #%02x%02x%02x", "Oo."[i], nr, ng, nb);
//      puts(tile_cmap[i]);
    }
...
//
// End of "$Id: Fl_get_system_colors.cxx,v 1.3 2008-05-05 15:25:59 vak Exp $".
//
